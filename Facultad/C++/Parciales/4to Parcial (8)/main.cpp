...
Devolucion: En Combo::eliminarItem, la excepción debía ser solo con texto
throw std::out_of_range("Elemento no encontrado en la lista.");
debía ser:
throw "Elemento no encontrado en la lista.";
En el constructor de Combo podría llamarse a setPorcentajeDescuento para unificar código.
